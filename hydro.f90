...
SUBROUTINE hydro
    ...
    !$ACC DATA &
    !$ACC COPYIN(chunks(1)%field%density0)   &
    !$ACC COPYIN(chunks(1)%field%density1)   &
    !$ACC COPYIN(chunks(1)%field%energy0)    &
    !$ACC COPYIN(chunks(1)%field%energy1)    &
    !$ACC COPYIN(chunks(1)%field%pressure)   &
    !$ACC COPYIN(chunks(1)%field%soundspeed) &
    !$ACC COPYIN(chunks(1)%field%viscosity)  &
    !$ACC COPYIN(chunks(1)%field%xvel0)      &
    !$ACC COPYIN(chunks(1)%field%yvel0)      &
    !$ACC COPYIN(chunks(1)%field%xvel1)      &
    !$ACC COPYIN(chunks(1)%field%yvel1)      &
    !$ACC COPYIN(chunks(1)%field%vol_flux_x) &
    !$ACC COPYIN(chunks(1)%field%vol_flux_y) &
    !$ACC COPYIN(chunks(1)%field%mass_flux_x)&
    !$ACC COPYIN(chunks(1)%field%mass_flux_y)&
    !$ACC COPYIN(chunks(1)%field%volume)     &
    !$ACC COPYIN(chunks(1)%field%work_array1)&
    !$ACC COPYIN(chunks(1)%field%work_array2)&
    !$ACC COPYIN(chunks(1)%field%work_array3)&
    !$ACC COPYIN(chunks(1)%field%work_array4)&
    !$ACC COPYIN(chunks(1)%field%work_array5)&
    !$ACC COPYIN(chunks(1)%field%work_array6)&
    !$ACC COPYIN(chunks(1)%field%work_array7)&
    !$ACC COPYIN(chunks(1)%field%cellx)      &
    !$ACC COPYIN(chunks(1)%field%celly)      &
    !$ACC COPYIN(chunks(1)%field%celldx)     &
    !$ACC COPYIN(chunks(1)%field%celldy)     &
    !$ACC COPYIN(chunks(1)%field%vertexx)    &
    !$ACC COPYIN(chunks(1)%field%vertexdx)   &
    !$ACC COPYIN(chunks(1)%field%vertexy)    &
    !$ACC COPYIN(chunks(1)%field%vertexdy)   &
    !$ACC COPYIN(chunks(1)%field%xarea)      &
    !$ACC COPYIN(chunks(1)%field%yarea)      &
